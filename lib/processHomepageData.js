import { normalizeWordPressUrl } from './urlUtils.js';
...
export function processHomepageData(data) {
  ...
  function replacePlaceholders(obj) {
    if (typeof obj === 'string') {
      ...
      // Normalize WordPress URLs in href attributes
      result = result.replace(/href="([^"]*)"/gi, (match, url) => {
        // Skip if it's a media URL (already handled above)
