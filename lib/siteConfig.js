...
const defaultNavItems = [
  { label: 'Hem', href: '/' },
  { label: 'Tjänster', href: '/digitala-tjanster/' },
...
export const siteConfig = {
  ...
  navCtaLabel: process.env.NAV_CTA_LABEL || 'TEST YOU HOME PAGE TODAY',
  navCtaHref: process.env.NAV_CTA_HREF || '/hemside-test/',
  contactEmail: process.env.COMPANY_EMAIL || 'patrik@digigrowth.se',
